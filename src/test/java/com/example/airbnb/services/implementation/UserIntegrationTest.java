...
class UserIntegrationTest {
    ...
    void register_ValidInput_ReturnsSuccess() throws Exception {
        ...
        mockMvc.perform(post("/api/users/register")
                ...
                .andExpect(jsonPath("$.username").value("fitz456"))
    ...
    void updateProfile_ValidInput_ReturnsUpdatedUser() throws Exception {
        ...
        registerRequest.setName("Fitz");
        registerRequest.setUsername("fitz_up");
        registerRequest.setEmail("fitz_up@example.com");
        registerRequest.setPassword("securePass2");
        ...
        mockMvc.perform(put("/api/users/1")
                ...
                .andExpect(status().isOk())
                .andExpect(jsonPath("$.name").value("Fitz Updated"))
                .andExpect(jsonPath("$.email").value("updated_fitz@example.com"))
                .andExpect(jsonPath("$.username").value("fitz_updated"));
    }
